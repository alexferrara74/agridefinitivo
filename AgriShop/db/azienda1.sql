...
CREATE DATABASE azienda1;DROP USER IF EXISTS 'tsw'@'localhost';
CREATE USER 'tsw'@'localhost' IDENTIFIED BY 'adminadmin';ì
GRANT ALL ON azienda1.* TO 'tsw'@'localhost';

USE azienda1;DROP TABLE IF EXISTS azienda;
...
('ortaggi');
INSERT INTO categoria VALUES
('frutta');INSERT INTO azienda VALUES
...
(3,654008935);
INSERT INTO produce VALUES
(20,539512508);INSERT INTO utilizza VALUES
(10000,'RSSMR00S53A509E','AA 000 XX');
INSERT INTO utilizza VALUES
(15000,'NRCRL68P57I619A','AV 568 SA');
INSERT INTO utilizza VALUES
(13500,'SPTRB66S93P987R','SA 741 OA');INSERT INTO ara VALUES
('AA 000 XX',13);
